...
public final class install_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(product_list == null){
		get_by_product = 1;
		product_list = serviceProductDao.findServiceProductByProgectIdAndNum(1,10,0);
		total = serviceProductDao.findServiceProductByProgectIdAndNum(1,0,0).size();
	}else{
	...
	int product_order = 0;
      ...
      out.write("    <title>帮您养车网－－安装改装</title>\r\n");
      out.write("\r\n");
      out.write("    <link href=\"");
      out.print(ctx);
      ...
      out.write("\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" style=\"height: 36px; line-height: 36px; color: #F0F0F0; font-size: 0.9em\">安装改装</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<!-- \t<div class=\"lafttitle_line1\"></div> -->\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 1 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=1&number=10&start=0\" >非防爆轮胎安装(17寸及一下/18寸及以上)</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 3 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=3&number=10&start=0\">防爆胎轮胎安装</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 5 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=5&number=10&start=0\">轮毂安装</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 9 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=9&number=10&start=0\">更换气门嘴</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 11 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=11&number=10&start=0\">轮胎换位</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 13 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=13&number=10&start=0\">换氮气</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 15 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=15&number=10&start=0\">安装氙气大灯</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 17 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=17&number=10&start=0\">安装胎压报警器(不含/含接线)</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 19 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=19&number=10&start=0\">安装倒车影像</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 23 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=23&number=10&start=0\">安装防眩镜</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 25 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=25&number=10&start=0\">安装车载导航</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 27 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=27&number=10&start=0\">安装车载导航含倒车影像</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 29 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=29&number=10&start=0\">安装倒车/可视倒车雷达</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"lafttitle_line2\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div ");
      out.print( get_by_product == 31 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<!-- <span>1</span> -->\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(ctx);
      out.write("/former/getproduct?sp_id=31&number=10&start=0\">安装行车记录仪</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<!-- <div class=\"lafttitle_line1\"></div> -->\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t");
							...
							int ordersize = 0;
							for(int p = 0;p < product_list.get(i).getOrders().size();p ++){
								if(product_list.get(i).getOrders().get(p).getState() >= 1 && product_list.get(i).getOrders().get(p).getState() < 4){
									ordersize ++ ;
								}
							}
      ...
      out.write("\t$($('.daohang_wenzi')[0]).attr(\"style\",\"color:#007fcc\");\r\n");
      out.write("});\r\n");
