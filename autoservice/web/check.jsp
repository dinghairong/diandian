...
<%
	...
	if(product_list == null){
		get_by_product = 113;
		product_list = serviceProductDao.findServiceProductByProgectIdAndNum(113,10,0);
		total = serviceProductDao.findServiceProductByProgectIdAndNum(113,0,0).size();
	}else{
				...
				<div class="leftNavi">
					<div class="lafttitle">
						<div class="lafttitle_name">
							<a href="javascript:void(0)" style="height: 36px; line-height: 36px; color: #F0F0F0; font-size: 0.9em">检测修正</a>
						</div>
						<!-- <div class="lafttitle_line1"></div> -->
						<div <%= get_by_product == 113 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=113&number=10&start=0">四轮定位调整</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 117 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=117&number=10&start=0">四轮定位检测</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 119 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=119&number=10&start=0">常用故障灯诊断</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 121 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=121&number=10&start=0">动平衡</a>
						</div>
						<!-- <div class="lafttitle_line1"></div> -->
					</div>
				</div>
...
$(function(){
	...
	$($('.daohang_wenzi')[3]).attr("style","color:#007fcc");
});
