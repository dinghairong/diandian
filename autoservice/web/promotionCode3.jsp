...
<%
	...
	List<UserCoupon> coupon_list = userCouponDao.findUserCouponByUserAndStatus(user.getId(),2);
%>
<head>
			...
			<div class="r_content">
				<div class="order_data w776" style="border-bottom:none;">
					<div class="order_tab2 w143">
						<a class="a" href="<%=ctx%>/promotionCode.jsp">未使用的优惠券</a>
						<a class="a" href="<%=ctx%>/promotionCode2.jsp">已使用的优惠券</a>
						<a class="act_tab2" href="<%=ctx%>/promotionCode3.jsp">已过期的优惠券</a>
					</div>
