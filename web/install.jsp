...
<head>
	...
	<link rel="stylesheet" href="<%=ctx%>/css/install.css">
				...
				<div class="leftNavi">
					<div class="lafttitle">
						<div class="lafttitle_name">
							<a href="javascript:void(0)" style="height: 36px; line-height: 36px; color: #F0F0F0; font-size: 0.9em">安装改装</a>
						</div>
					<!-- 	<div class="lafttitle_line1"></div> -->
						<div <%= get_by_product == 1 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							
							<a href="<%=ctx%>/former/getproduct?sp_id=1&number=10&start=0" >非防爆轮胎安装(17寸及一下/18寸及以上)</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 3 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							
							<a href="<%=ctx%>/former/getproduct?sp_id=3&number=10&start=0">防爆胎轮胎安装</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 5 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
						
							<a href="<%=ctx%>/former/getproduct?sp_id=5&number=10&start=0">轮毂安装</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 9 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=9&number=10&start=0">更换气门嘴</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 11 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=11&number=10&start=0">轮胎换位</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 13 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=13&number=10&start=0">换氮气</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 15 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=15&number=10&start=0">安装氙气大灯</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 17 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=17&number=10&start=0">安装胎压报警器(不含/含接线)</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 19 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=19&number=10&start=0">安装倒车影像</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 23 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=23&number=10&start=0">安装防眩镜</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 25 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=25&number=10&start=0">安装车载导航</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 27 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=27&number=10&start=0">安装车载导航含倒车影像</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 29 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<a href="<%=ctx%>/former/getproduct?sp_id=29&number=10&start=0">安装倒车/可视倒车雷达</a>
						</div>
						<div class="lafttitle_line2"></div>
						<div <%= get_by_product == 31 ? "class='lafttitle_select'" : "class='lafttitle_unselect'" %>>
							<!-- <span>1</span> -->
							<a href="<%=ctx%>/former/getproduct?sp_id=31&number=10&start=0">安装行车记录仪</a>
						</div>
						<!-- <div class="lafttitle_line1"></div> -->
					</div>
				</div>
				...
				<div id="Products">
					...
					<div style="height: 121px; padding: 10px 18px; border-bottom: 1px #F9F9F9 solid">
						...
						<div style="float: right; padding: 6px 18px">
							...
							<div><span style="font-size: 0.7em; color: #999999;">本商品已有<span><%= ordersize%></span>人购买</span></div>
						</div>	
					</div>	
					<%
					}
